...
const PortfolioCard = ({src,title,pera}) => {
  return (
    <div className='mx-auto w-[350px] sm:w-[500px] md:w-[48vw] lg:w-full'>
      <div className='group relative cursor-pointer'>
        <Image src={src} className="w-full h-[420px]"/>
        <div className='hidden lg:block absolute top-0 left-0 w-0 h-full group-hover:bg-[#00413d66] group-hover:w-full duration-300'>
